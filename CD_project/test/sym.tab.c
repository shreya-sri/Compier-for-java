...
{
       0,    46,    46,    47,    51,    55,    59,    60,    61,    65,
      69,    70,    74,    75,    76,    77,    81,    82,    86,    87,
      91,    95,    96,    97,   101,   101,   105,   106,   107,   108,
     109,   110,   111,   111,   111,   112,   113,   114,   115,   119,
     120,   124,   125,   130,   129,   137,   136,   146,   151,   156,
     160,   161,   162,   166,   167,   168,   169,   173,   174,   175,
     176,   180,   181,   182,   186,   187,   188,   192,   205,   206,
     207,   208,   209,   210,   211,   212,   213,   217,   218,   219,
     220,   221,   222,   223,   224,   225,   226,   227,   228,   229,
     230,   231,   232,   233,   234,   238,   239,   240,   241,   242,
     243,   247,   248,   252,   253,   261,   262,   263,   264,   268,
     269,   282
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$@3", "SwitchBlock", "SwitchLabel", "VarDec", "$@4", "$@5",
  "DecIdenList", "ArrDec", "ArrList", "ArrInit", "ArrExp", "Type",
  "Assign", "AssignOp", "InfixOp", "PrefixOp", "PostfixOp", "Expression",
  "Expr", "Epr", YY_NULLPTR
};
#endif
